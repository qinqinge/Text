...
@implementation XMHQQuickUIUitil
...
{
    return [XMHQQuickUIUitil colorFromRed:red green:green blue:blue withAlpha:1.0];
}
...
{
    return [XMHQQuickUIUitil layerScreenShot:aView.layer];
}

+ (UIImage *)layerScreenShot:(CALayer *)layer
{
    if (XMHQCheckObjectNull(layer)) {
        return nil;
    }
...
{
    if (XMHQCheckObjectNull(backgroundImage)) {
        return nil;
    }
...
+ (UIImage *)correctFullSolutionImageFromALAsset:(ALAsset *)asset withScaleSize:(CGFloat)scaleSize
{
    ...
    return [XMHQQuickUIUitil correctImageOrientation:fullSolutionImage withScaleSize:scaleSize];
}

+ (UIImage *)correctFullSolutionImageFromALAsset:(ALAsset *)asset
{
    return [XMHQQuickUIUitil correctFullSolutionImageFromALAsset:asset withScaleSize:1.0];
}

+ (UIImage *)correctImageOrientation:(UIImage *)aImage
{
    return [XMHQQuickUIUitil correctImageOrientation:aImage withScaleSize:1.0];
}
...
+ (UIImage *)roundImage:(UIImage *)aImage
{
    ...
    aImage = [XMHQQuickUIUitil partImage:aImage withRect:imageRect];
...
{
    return [XMHQQuickUIUitil gradientLinearImageFromColors:@[fromColor,toColor,fromColor] withImageSize:size];
}

+ (UIImage *)gradientLinearImageFromColors:(NSArray *)colors withImageSize:(CGSize)size;
{
    if (XMHQCheckObjectNull(colors)) {
        return nil;
    }
...
{
    return [XMHQQuickUIUitil gradientRadialImageFromColors:@[fromColor,toColor] withImageSize:size];
}
...
{
    return [XMHQQuickUIUitil gridImageByHoriLineGap:lineGap withVerticalLineGap:0.f withLineColor:lineColor withImageSize:size];
}

+ (UIImage *)gridImageVerticalByLineGap:(CGFloat)lineGap withLineColor:(UIColor *)lineColor withImageSize:(CGSize)size
{
    return [XMHQQuickUIUitil gridImageByHoriLineGap:0.f withVerticalLineGap:lineGap withLineColor:lineColor withImageSize:size];
}
...
{
    if (XMHQCheckObjectNull(originImage)) {
        return nil;
    }
...
{
    [XMHQQuickUIUitil animationDelay:0 animationDuration:duration action:block];
}

+ (void)animationDelay:(NSTimeInterval )delaySecond animationDuration:(NSTimeInterval)duration action:(dispatch_block_t)block
{
    if (XMHQCheckObjectNull(block)) {
        return;
    }
    
    XMHQAsyncMainQueueDelay(delaySecond, ^{
...
+ (void)animationView:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block withOptions:(UIViewAnimationOptions)options completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil animationView:view delay:0 animationDuration:duration action:block withOptions:options completionBlock:completion];
}

+ (void)animationView:(UIView *)view delay:(NSTimeInterval)delaySecond animationDuration:(NSTimeInterval)duration action:(dispatch_block_t)block withOptions:(UIViewAnimationOptions)options completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    if (XMHQCheckObjectNull(view)) {
        return;
    }
...
{
    [XMHQQuickUIUitil hiddenShowView:view withDuration:0.3];
}

+ (void)defaultShowHiddenView:(UIView *)view
{
    [XMHQQuickUIUitil showHiddenView:view withDuration:0.3];
}

+ (void)defaultHiddenView:(UIView *)view
{
    [XMHQQuickUIUitil hiddenView:view withDuration:0.3];
}

+ (void)defaultShowView:(UIView *)view
{
    [XMHQQuickUIUitil showView:view withDuration:0.3];
}

+ (void)hiddenView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:0 withDuration:duration];
}

+ (void)showView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:1 withDuration:duration];
}

+ (void)showView:(UIView *)view finalAlpha:(CGFloat)alpha withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil animationView:view fromAlpha:view.alpha toAlpha:alpha withDuration:duration];
}

+ (void)hiddenShowView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil animationView:view fromAlpha:0 toAlpha:1 withDuration:duration];
}

+ (void)showHiddenView:(UIView *)view withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil animationView:view fromAlpha:1 toAlpha:0 withDuration:duration];
}
...
+ (void)animationView:(UIView *)view fromAlpha:(CGFloat)fAlpha toAlpha:(CGFloat)tAlpha withDuration:(NSTimeInterval)duration
{
    ...
    XMHQAnimationWithDuration(duration, ^{
...
{
    [XMHQQuickUIUitil moveView:view originXDetal:moveX originYDetal:0.f widthDetal:0.f heightDetla:0.f withDuration:duration];
}

+ (void)moveViewY:(UIView *)view originYDetal:(CGFloat)moveY withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil moveView:view originXDetal:0.f originYDetal:moveY widthDetal:0.f heightDetla:0.f withDuration:duration];
}

+ (void)moveViewWidth:(UIView *)view widthDetal:(CGFloat)moveWidth withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil moveView:view originXDetal:0.f originYDetal:0.f widthDetal:moveWidth heightDetla:0.f withDuration:duration];
}

+ (void)moveViewHeight:(UIView *)view heightDetal:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    [XMHQQuickUIUitil moveView:view originXDetal:0.f originYDetal:0.f widthDetal:0.f heightDetla:moveHeight withDuration:duration];
}
...
+ (void)moveViewToX:(UIView *)view toOriginX:(CGFloat)moveX withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil moveViewX:view originXDetal:detal withDuration:duration];
}
...
+ (void)moveViewToY:(UIView *)view toOriginY:(CGFloat)moveY withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil moveViewY:view originYDetal:detal withDuration:duration];
}
...
+ (void)moveViewToWidth:(UIView *)view toWidth:(CGFloat)moveWidth withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil moveViewWidth:view widthDetal:detal withDuration:duration];
}
...
+ (void)moveViewToHeight:(UIView *)view toHeight:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil moveViewHeight:view heightDetal:detal withDuration:duration];
}
...
+ (void)moveViewSize:(UIView *)view newSize:(CGSize)size withDuration:(NSTimeInterval)duration
{
    ...
    newFrame.size = size;
    XMHQAnimationMoveViewRect(view, newFrame, duration);
}
...
+ (void)moveView:(UIView *)view originXDetal:(CGFloat)moveX originYDetal:(CGFloat)moveY widthDetal:(CGFloat)moveWidth heightDetla:(CGFloat)moveHeight withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil moveView:view newRect:newFrame withDuration:duration];
}

+ (void)flipViewFromLeft:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil flipView:view fromLeft:YES fromRight:NO fromTop:NO fromBottom:NO action:block withDuration:duration completionBlock:completion];
}

+ (void)flipViewFromRight:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil flipView:view fromLeft:NO fromRight:YES fromTop:NO fromBottom:NO action:block withDuration:duration completionBlock:completion];
}

+ (void)flipViewFromTop:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil flipView:view fromLeft:NO fromRight:NO fromTop:YES fromBottom:NO action:block withDuration:duration completionBlock:completion];
}

+ (void)flipViewFromBottom:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil flipView:view fromLeft:NO fromRight:NO fromTop:NO fromBottom:YES action:block withDuration:duration completionBlock:completion];
}

+ (void)flipView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(XMHQQuickAnimationCompletionBlock)completion;
{
    if (XMHQCheckObjectNull(view)) {
        return;
    }
    if (isLeft) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromLeft completionBlock:completion];
    }
    if (isRight) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromRight completionBlock:completion];
    }
    if (isTop) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromTop completionBlock:completion];
    }
    if (isBottom) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionFlipFromBottom completionBlock:completion];
    }
}

+ (void)pageUpViewFromBottom:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil pageUpView:view fromLeft:NO fromRight:NO fromTop:NO fromBottom:YES action:block withDuration:duration completionBlock:completion];
}

+ (void)pageUpView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(XMHQQuickAnimationCompletionBlock)completion;
{
    if (XMHQCheckObjectNull(view)) {
        return;
    }
    if (isBottom) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCurlUp|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
    }
}

+ (void)pageDownViewFromTop:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    [XMHQQuickUIUitil pageDownView:view fromLeft:NO fromRight:NO fromTop:YES fromBottom:NO action:block withDuration:duration completionBlock:completion];
}

+ (void)pageDownView:(UIView *)view fromLeft:(BOOL)isLeft fromRight:(BOOL)isRight fromTop:(BOOL)isTop fromBottom:(BOOL)isBottom action:(dispatch_block_t)block withDuration:(NSTimeInterval)duration completionBlock:(XMHQQuickAnimationCompletionBlock)completion;
{
    if (XMHQCheckObjectNull(view)) {
        return;
    }
    if (isTop) {
        [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCurlDown|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
    }
}

+ (void)cubeView:(UIView *)view withDuration:(NSTimeInterval)duration action:(dispatch_block_t)block completionBlock:(XMHQQuickAnimationCompletionBlock)completion
{
    if (XMHQCheckObjectNull(view)) {
        return;
    }
    [XMHQQuickUIUitil animationView:view withDuration:duration action:block withOptions:UIViewAnimationOptionTransitionCrossDissolve|UIViewAnimationOptionCurveEaseInOut completionBlock:completion];
}
...
+ (void)rotationViewX:(UIView *)view withDegree:(CGFloat)degree withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil animationView:view withAnimationPath:path toValue:XMHQDegreeToRadiusValue(degree) withDuration:duration];
}
...
+ (void)translationViewX:(UIView *)view withOriginX:(CGFloat)originX withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil animationView:view withAnimationPath:path toValue:@(originX) withDuration:duration];
}
...
+ (void)translationViewY:(UIView *)view withOriginY:(CGFloat)originY withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil animationView:view withAnimationPath:path toValue:@(originY) withDuration:duration];
}
...
+ (void)translationViewZ:(UIView *)view withOriginZ:(CGFloat)originZ withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil animationView:view withAnimationPath:path toValue:@(originZ) withDuration:duration];
}
...
+ (void)scaleViewX:(UIView *)view withScaleSize:(CGFloat)size withDuration:(NSTimeInterval)duration
{
    ...
    [XMHQQuickUIUitil animationView:view withAnimationPath:path toValue:@(size) withDuration:duration];
}
...
+ (void)animationView:(UIView *)view withAnimationPath:(NSString *)path toValue:(NSValue *)value withDuration:(NSTimeInterval)duration
{
    ...
    [view.layer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"XMHQAnimation_%@_%lu_%lu_%f",path,[view hash],[value hash],duration]];
}

+ (void)view3DRotateX:(UIView *)view withDegree:(CGFloat)degree
{
    [XMHQQuickUIUitil view3DRotate:view x:1 y:0 z:0 withDegree:XMHQDegreeToRadius(degree)];
}

+ (void)view3DRotateY:(UIView *)view withDegree:(CGFloat)degree
{
    [XMHQQuickUIUitil view3DRotate:view x:0 y:1 z:0 withDegree:XMHQDegreeToRadius(degree)];
}

+ (void)view3DRotateZ:(UIView *)view withDegree:(CGFloat)degree
{
    [XMHQQuickUIUitil view3DRotate:view x:0 y:0 z:1 withDegree:XMHQDegreeToRadius(degree)];
}
...
+ (void)view3DRotate:(UIView *)view x:(CGFloat)xState y:(CGFloat)yState z:(CGFloat)zState withDegree:(CGFloat)degree
{
    ...
    XMHQAnimationWithDuration(0.35, ^{
...
{
    [XMHQQuickUIUitil view3DTranslate:view x:value y:0 z:0];
}

+ (void)view3DTranslateY:(UIView *)view withValue:(CGFloat)value
{
    [XMHQQuickUIUitil view3DTranslate:view x:0 y:value z:0];
}

+ (void)view3DTranslateZ:(UIView *)view withValue:(CGFloat)value
{
    [XMHQQuickUIUitil view3DTranslate:view x:0 y:0 z:value];
}
...
{
    [XMHQQuickUIUitil view3DScale:view x:value y:0 z:0];
}

+ (void)view3DScaleY:(UIView *)view withValue:(CGFloat)value
{
    [XMHQQuickUIUitil view3DScale:view x:0 y:value z:0];
}

+ (void)view3DScaleZ:(UIView *)view withValue:(CGFloat)value
{
    [XMHQQuickUIUitil view3DScale:view x:0 y:0 z:value];
}
...
+ (XMHQQuickUIUitil *)shareQuickUIUitil
{
    static XMHQQuickUIUitil *_shareQuickUIInstance = nil;
...
{
    if (XMHQStringIsNull(blockIdentifier)) {
        return;
    }
    if (self.repeatActionInfoDict.count == 0) {
        return;
...
{
    return  [XMHQQuickUIUitil repeatDoAction:block withDelay:0.f];
}

+ (NSString *)repeatDoAction:(dispatch_block_t)block withDelay:(NSTimeInterval)delaySecond
{
    return [XMHQQuickUIUitil repeatDoAction:block withDelay:delaySecond withRepeatDuration:0];
}

+ (NSString *)repeatDoAction:(dispatch_block_t)block withRepeatDuration:(NSTimeInterval)duration
{
    return [XMHQQuickUIUitil repeatDoAction:block withDelay:0 withRepeatDuration:duration];
}
...
+ (NSString *)repeatDoAction:(dispatch_block_t)block withDelay:(NSTimeInterval)delaySecond withRepeatDuration:(NSTimeInterval)duration
{
    ...
    NSString *blockIdentifier = XMHQStringCurrentTimeStamp;
    ...
    XMHQAsyncMainQueueDelay(delaySecond, ^{
        ...
        [[XMHQQuickUIUitil shareQuickUIUitil]addRepeatBlockInfo:blockActionInfo];
        [[XMHQQuickUIUitil shareQuickUIUitil]startRepeatAction];
...
+ (void)stopRepeatAction:(NSString *)blockIdentifier
{
    ...
    [[XMHQQuickUIUitil shareQuickUIUitil]removeBlockInfo:blockIdentifier];
}

+ (void)animationViewXCycle:(UIView *)view withXMoveDetal:(CGFloat)moveX withDuration:(NSTimeInterval)duration
{
    XMHQAnimationViewTranslationX(view, moveX, duration);
    XMHQAnimationViewTranslationX(view, 0, duration);
    XMHQAnimationViewTranslationX(view, -moveX, duration);
    XMHQAnimationViewTranslationX(view, 0, duration);
}
...
{
    XMHQAnimationViewTranslationY(view, moveY, duration);
    XMHQAnimationViewTranslationY(view, 0, duration);
    XMHQAnimationViewTranslationY(view, -moveY, duration);
    XMHQAnimationViewTranslationY(view, 0, duration);
}
...
{
    XMHQAnimationViewTranslationZ(view, moveZ, duration);
    XMHQAnimationViewTranslationZ(view, 0, duration);
    XMHQAnimationViewTranslationZ(view, -moveZ, duration);
    XMHQAnimationViewTranslationZ(view, 0, duration);
}
...
{
    XMHQAnimationViewRotateX(view, xDegree, duration);
    XMHQAnimationViewRotateX(view, 0, duration);
    XMHQAnimationViewRotateX(view, -xDegree, duration);
    XMHQAnimationViewRotateX(view, 0, duration);
}
...
{
    XMHQAnimationViewRotateY(view, yDegree, duration);
    XMHQAnimationViewRotateY(view, 0, duration);
    XMHQAnimationViewRotateY(view, -yDegree, duration);
    XMHQAnimationViewRotateY(view, 0, duration);
}
...
{
    XMHQAnimationViewRotateZ(view, zDegree, duration);
    XMHQAnimationViewRotateZ(view, 0, duration);
    XMHQAnimationViewRotateZ(view, -zDegree, duration);
    XMHQAnimationViewRotateZ(view, 0, duration);
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position.x" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position.y" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position" withFromValue:fromValue withToValue:toValue withRepeatCount:repeatCount withDuration:duration];
}
...
{
    if (XMHQCheckObjectNull(aLayer) || XMHQStringIsNull(path) || XMHQCheckKeyValueHasNull(fromValue, toValue)) {
        return;
    }
    ...
    [aLayer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"XMHQ_animation_%@",path]];
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position.x" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position.y" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    return [XMHQQuickUIUitil animationLayer:aLayer path:@"position" ByValue:value withRepeatCount:repeatCount withDuration:duration];
}
...
{
    if (XMHQCheckObjectNull(aLayer) || XMHQStringIsNull(path) || XMHQCheckObjectNull(value)) {
        return;
    }
    ...
    [aLayer addAnimation:basicAnimation forKey:[NSString stringWithFormat:@"XMHQ_animation_by_%@",path]];
...
+ (UIImage *)imageWithAlpha:(UIImage *)aImage {
    if ([XMHQQuickUIUitil hasAlpha:aImage]) {
        return aImage;
    }
...
+ (UIImage *)roundedCornerImage:(UIImage *)aImage cornerSize:(NSInteger)cornerSize borderSize:(NSInteger)borderSize {
    ...
    UIImage *image = [XMHQQuickUIUitil imageWithAlpha:aImage];
    ...
    CGContextBeginPath(context);
    [XMHQQuickUIUitil addRoundedRectToPath:CGRectMake(scaledBorderSize, scaledBorderSize, image.size.width*scale - borderSize * 2, image.size.height*scale - borderSize * 2)
                                   context:context
...
+ (UIImage *)createRoundCornerImage:(UIImage *)aImage withCornerSize:(NSInteger)cornerSize withBoardSize:(NSInteger)boardSize
{
    ...
    return [XMHQQuickUIUitil roundedCornerImage:aImage cornerSize:cornerSize borderSize:boardSize];
}
